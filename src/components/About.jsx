        ...
        <div className="grid md:grid-cols-2 place-items-center">
          ...
          <div className="">
            <div className="section_title ">
              <p className='text-base uppercase font-nunito text-indigo-600 relative'> <img src= {heartbeat_Icon} alt="" className='w-[36px] absolute top-1' /><span className='ml-12'>Why Choose Us</span> </p>
